...
if (homeGallery) {
  ...
  if (heroSection && heroCopy) {
    ...
    mobileBenefits.innerHTML = '<article><span class="benefit-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 8h12l1 12H5L6 8Z"/><path d="M9 8V6a3 3 0 0 1 6 0v2"/></svg></span><strong>$70.000</strong><span>Mínimo de compra</span></article><article><span class="benefit-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 10h18"/></svg></span><strong>Pago simple</strong><span>Tarjetas, transferencia y efectivo</span></article><article><span class="benefit-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M3 6h11v11H3z"/><path d="M14 10h4l3 3v4h-7z"/><path d="M7 20a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm11 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/></svg></span><strong>Todo el país</strong><span>Envíos a destinos nacionales</span></article><article><span class="benefit-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 13a8 8 0 0 1 16 0"/><path d="M4 13v3a2 2 0 0 0 2 2h1v-5H4Zm16 0v3a2 2 0 0 1-2 2h-1v-5h3Z"/><path d="M15 20h-3a2 2 0 0 1-2-2"/></svg></span><strong>Atención cercana</strong><span>Te acompañamos en cada pedido</span></article>';
