...
const dashboardMenuLabel = document.querySelector('#dashboard-menu-label');
...
const publicRubrosMenu = document.querySelector('.public-page .side-nav, .catalog-page .side-nav, .auth-page .side-nav');
